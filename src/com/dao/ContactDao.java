...
public class ContactDao {
	...
	public boolean saveContact(Contact c) {
		...
		try {
   		...
   		prepareStatement.setString(4,c.getAbout()); 
   		prepareStatement.setInt(5,c.getUserId()); 
	...
	public Contact getContact(int cid) {
		...
		try {
			PreparedStatement prepareStatement = conn.prepareStatement("select * from contact where id=?");
	...
	public boolean updateContact(Contact c) {
		...
		try {
   		 ...
   		 prepareStatement.setString(3,c.getPhone()); 
   		prepareStatement.setString(4,c.getAbout()); 
   		prepareStatement.setInt(5,c.getId()); 
   		 int i =prepareStatement.executeUpdate();
   		if(i>0) {
			 f=true;
		 }
